...
public class EstimatedCostPageTest {
    ...
    public void chekDataTest(){
        ...
        estimatedCostPage.checkVMClass("Regular");
        estimatedCostPage.checkInstanceType("n1-standard-8");
        estimatedCostPage.checkRegion("Frankfurt");
        estimatedCostPage.checkLocalSSD("2x375 GiB");
        estimatedCostPage.checkCommitmentTerm("1 Year");

        estimatedCostPage.checkTotalEstimatedCost("USD 4,024.56 per 1 month");
    }
